...
- 📐 **固定比例画布** — 小红书 3:4、方形 1:1、PPT 16:9、微信公众号排版，原生像素渲染
...
在比例选择器里选择「微信公众号排版」，生成或编辑完成后点击「复制公众号 HTML」。CardMaker 会把当前 deck 转成带内联样式的 HTML 片段，复制到剪贴板后可直接粘贴到微信公众号编辑器，保留标题、段落、重点块和引用等基础格式。
...
| `story` | 公众号 | 430×932 起 | 微信公众号图文 / 手机阅读宽度 / 可复制 HTML |
